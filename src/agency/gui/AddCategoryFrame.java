 ...
 * @author Gayath
 */
public class AddCategoryFrame extends javax.swing.JDialog {
     ...
     */
    public AddCategoryFrame(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocation(300, 200);
...
////        System.gc();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddCategoryFrame dialog = new AddCategoryFrame(new javax.swing.JFrame(), true);
