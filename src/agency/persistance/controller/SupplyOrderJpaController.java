 ...
 * @author Sandaruwan
 */
public class SupplyOrderJpaController extends Observable implements SupplyOrderController {

    public static String LOCATION = "address";
    public static String compNAME = "compName";
    public static String NAME = "name";

    public SupplyOrderJpaController(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    public void edit(SupplyOrder supplyOrder) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                Long id = supplyOrder.getSoid();
                if (findSupplyOrder(id) == null) {
                    throw new NonexistentEntityException("The supplyOrder with id " + id + " no longer exists.");
                }
            }
            throw ex;
        } finally {
    ...
    public void destroy(Long id) throws NonexistentEntityException {
        ...
        try {
            ...
            try {
                ...
                throw new NonexistentEntityException("The supplyOrder with id " + id + " no longer exists.", enfe);
            }
